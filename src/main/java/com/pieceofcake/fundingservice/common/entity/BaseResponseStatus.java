...
public enum BaseResponseStatus {
    ...
    REDIS_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, false, 904, "Redis 저장에 실패했습니다."),
    /**
     * 2000: funding service error
     */
    NO_EXIST_FUNDING(HttpStatus.NOT_FOUND, false, 2001, "공모 상품이 존재하지 않습니다."),
    FAILED_TO_UPDATE(HttpStatus.INTERNAL_SERVER_ERROR, false, 2002, "공모가 이미 진행중입니다."),
    ...
    NO_PARTICIPATION_HISTORY(HttpStatus.INTERNAL_SERVER_ERROR, false, 2005, "참여내역이 없습니다."),
